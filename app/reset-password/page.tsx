          ...
          <CardContent>
            {checkingSession ? (
              ...
              <div className="space-y-4">
                ...
                <Link href="/forgot-password" className="block text-center text-sm text-primary hover:underline font-medium">
              ...
              <div className="text-center space-y-2 py-4">
                ...
                <p className="text-sm text-muted-foreground">Password updated! Taking you to your dashboard...</p>
              </div>
            ) : (
